...
NAMES = ['NextEra Energy', 'Duke Energy', 'Southern Company', 'Xcel Energy (XEL)', 'American Electric Power', 'Constellation Energy Corp.', 'Sempra']

st.set_page_config(page_title='Utilities Stocks', layout='wide')
st.header('Utilites Stock Dashboard')
st.subheader('Analyze the real time data here')
st.markdown('---')
