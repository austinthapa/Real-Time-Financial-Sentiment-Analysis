...
st.set_page_config(page_title='Technology Stocks', layout='wide')
st.header('Technology Financial Dashboard')
st.subheader('Information Technology: The Engine of Innovation')
st.markdown('---')
