...
STOCKS = ['JPM', 'GS', 'BRK.B', 'BAC', 'MS', 'WFC', 'C']
NAMES =  ['JP Morgan Chase Bank', 'Goldman Sachs', 'Berkshire Hatheway', 'Bank of America', 'Morgan Stanley', 'Wells Fargo & Company', 'Citigroup Inc.']

# Set up Streamlit page
st.set_page_config(page_title='Finance Stocks', layout='wide')
st.header('Financial Stock Dashboard')
st.subheader('Financial: The Foundation of Commerce')
st.markdown('---')
