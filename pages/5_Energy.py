...
STOCKS = ['XOM', 'CVX', 'COP', 'NEE', 'EOG', 'SLB', 'KMI']
NAMES =  ['Exxon Mobil Corporation', 'Chevron Corporation', 'CononcoPhillips', 'NextEra Energy', 'EOG Resources, Inc.', 'Schlumberger N.V', 'Kinder Morgan, Inc.']

# Set up Streamlit page
st.set_page_config(page_title='Energy Stocks', layout='wide')
